        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" action="<?php echo base_url('loginadmin/register'); ?>" method="post">
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="id" id="exampleFirstName" placeholder="ID Pengelola">
                    <small  class="form-text text-danger"><?php echo form_error('id'); ?></small>
                  </div>
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="fullname" id="exampleLastName" placeholder="Nama Lengkap">
              ...
              <div class="text-center">
                <a class="small" href="<?= base_url() ?>loginadmin">Already have an account? Login!</a>
              </div>
            </div>
          </div>
        </div>
